...
const PaymentSuccess = () => {
  ...
  const [seconds, setSeconds] = useState(8); // Increased time to view ticket
    ...
    const fetchLatestBooking = async () => {
      try {
        ...
        if (response.data.data && response.data.data.length > 0) {
          // Get the most recent booking (first in the sorted array)
          const latestBooking = response.data.data[0];
          ...
          >
            ...
            <div className="flex flex-col md:flex-row gap-6 mb-6">
              ...
              <div className="flex-shrink-0 mx-auto md:mx-0">
                <img
                  src={bookingDetails.moviePoster || "https://via.placeholder.com/120x180?text=No+Poster"}
              ...
              <div className="flex-1 space-y-3">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-semibold">{new Date(bookingDetails.showTime).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}</p>
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {bookingDetails.bookedSeats.map((seat, index) => (
                      <span
                        key={index}
